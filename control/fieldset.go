...
func (c *Fieldset) Init(self page.ControlI, parent page.ControlI, id string) {
...
func (c *Fieldset) DrawingAttributes(ctx context.Context) html5tag.Attributes {
	...
	a.SetData(page.ControlTypeDataAttribute, "fieldset")
	return a
}
...
func init() {
	page.RegisterControl(func() page.ControlI { return new(Fieldset) })
}
