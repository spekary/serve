...
func (c *Canvas) Init(self page.ControlI, parent page.ControlI, id string) {
...
func (c *Canvas) DrawingAttributes(ctx context.Context) html5tag.Attributes {
	...
	a.SetData(page.ControlTypeDataAttribute, "canvas")
	return a
}
...
func init() {
	page.RegisterControl(func() page.ControlI { return new(Canvas) })
}
