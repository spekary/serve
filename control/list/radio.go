...
type RadioListI interface {
	...
	SetLayoutDirection(direction control2.LayoutDirection) RadioListI
...
type RadioList struct {
	...
	direction control2.LayoutDirection
...
func (l *RadioList) SetLayoutDirection(direction control2.LayoutDirection) RadioListI {
...
func (l *RadioList) LayoutDirection() control2.LayoutDirection {
	return l.direction
}
...
func renderCheckItemControl(item *Item, typ string, labelMode html5tag.LabelDrawingMode, selected bool, name string) string {
...
func renderCell(item *Item, controlHtml string, hasColumns bool) string {
...
type RadioListCreator struct {
	...
	LayoutDirection control2.LayoutDirection
