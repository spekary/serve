...
type CheckboxListI interface {
	...
	SetLayoutDirection(direction control2.LayoutDirection) CheckboxListI
...
func (l *CheckboxList) SetLayoutDirection(direction control2.LayoutDirection) CheckboxListI {
...
func (l *CheckboxList) LayoutDirection() control2.LayoutDirection {
	return l.direction
}
